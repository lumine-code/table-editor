...
module.exports = class Range {
  ...
  static deserialize(array) {
    return Array.isArray(array) ? new this(array[0], array[1]) : new this();
  }
  ...
  containsRange(otherRange) {
    ...
    return (
      this.containsPoint(start) &&
      this.containsPoint({ row: end.row - 1, column: end.column - 1 })
    );
  }
  ...
  containsColumn(column) {
    return this.start.column <= column && column < this.end.column;
  }
